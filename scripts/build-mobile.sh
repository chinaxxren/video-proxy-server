...
case "${PLATFORM:-all}" in
  ...
  android) build_target android aarch64-linux-android cdylib; build_target android armv7-linux-androideabi cdylib; build_target android x86_64-linux-android cdylib; install_adapter_template android platform/android/MediaProxyCache.kt ;;
